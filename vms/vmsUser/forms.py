...
class RequisitionForm(forms.ModelForm):
    ...
    aplctn_date = forms.DateTimeField(required=True, label='Enter Date', widget=forms.TextInput(attrs={'class': 'form-control'}))
    ...
    class Meta:
        ...
        fields = ('aplctn_date', 'user_name', 'designation', 'department', 'jour_purpose', 'jour_date', 'vcl_type', 'destination', 'departr_time', 'rtrn_time', 'jour_details')
